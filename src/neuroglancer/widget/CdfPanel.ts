import {inputEventMap, getUpdatedParameters, NUM_CDF_LINES, histogramSamplerTextureUnit} from "neuroglancer/widget/invlerpUtils"
...
import {
  computeInvlerp, computeLerp, DataTypeInterval,
  getClampedInterval, getClosestEndpoint, getIntervalBoundsEffectiveFraction,
...
export class CdfPanel extends RenderedPanel {
  get drawOrder() {
    return 100;
  }
